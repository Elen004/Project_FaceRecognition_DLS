...
# Описание репозитория GitHub:
   ...
   3. В Part3_Итоговый пайплайн.py представлено применение обученных моделей и подсчёт эмбендингов между изображениями (задание №3)
...
В папке "Пайплайны" представлены ноутбуки Part1_Stacked_Hourglass_Network.ipnb (задание №1 Face Alignment), Part_2_Модель_AC_loss_ArcFace.ipnb (задание №2 CE loss и ArcFace), Part3_Итоговый пайплайн.ipnb (задание №3)
...
**V. Тестовые изображения**
В папке "Тестовые изображения" хранятся 3 избражения, подавались на вход в Part3_Итоговый пайплайн для подсчёта эмбендингов
