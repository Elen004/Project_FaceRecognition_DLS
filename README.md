...
2. В файле Part_2_Модель_AC_loss_ArcFace выполнено обучение модели с использованием CrossEntropy loss, приведена реализациия ArcFace и выполнено обучение модели на ArcFace loss (задание №2 ArcFace).
